...
class _ReportsScreenState extends State<ReportsScreen> {
  ...
  Future<void> _loadWeeklyData() async {
    ...
    // احصل على العادات المختارة من الخريطة
    ...
    // إذا لم يتم اختيار أي عادات، قم بإعادة تعيين weeklyData
    ...
    // قم بتحميل البيانات من تفضيلات المشاركة أو توليد بيانات مختلطة عشوائية إذا لم توجد
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: weeklyData.isEmpty
          ? const Center(
              child: Text(
                'لا توجد بيانات متاحة. يرجى تكوين العادات أولاً.',
  ...
  List<DataColumn> _buildColumns() {
    return [
      const DataColumn(
        label: Text('العادة', style: TextStyle(fontWeight: FontWeight.bold)),
      ),
